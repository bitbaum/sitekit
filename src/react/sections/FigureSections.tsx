...
import { SectionBody, SectionHeading } from './Primitives.js';
 ...
 * because an empty bar is the honest picture of an unfinished phase. Anything
 * that dressed a 0% up as progress would be the page lying.
 */
